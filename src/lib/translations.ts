...
export const translations = {
  KR: {
    ...
    toastErrorInvalidRatingRangeDesc: "현재 레이팅은 0.00-18.00, 목표 레이팅은 0.00-17.50 사이여야 합니다.",
  ...
  JP: {
    ...
    toastErrorInvalidRatingRangeDesc: "現在レーティングは0.00～18.00、目標レーティングは0.00～17.50の間である必要があります。",
