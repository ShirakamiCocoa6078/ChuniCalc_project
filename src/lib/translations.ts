...
export const translations = {
  KR: {
    ...
    tooltipCalcStrategyContentLine1: "&lt;strong&gt;Best 30 集中:&lt;/strong&gt; Best 30の曲のみで目標達成経路を計算します。",
    tooltipCalcStrategyContentLine2: "&lt;strong&gt;New 20 集中:&lt;/strong&gt; New 20の曲のみで目標達成経路を計算します。",
    tooltipCalcStrategyContentLine3: "&lt;strong&gt;全体(低点優先):&lt;/strong&gt; 全ての曲を対象に、現在レーティングが低い曲からスコアを上げる現実的な経路を計算します。",
    tooltipCalcStrategyContentLine4: "&lt;strong&gt;全体(高点優先):&lt;/strong&gt; 全ての曲を対象に、現在レーティングが高い曲をさらに成長させる効率的な経路を計算します。",
